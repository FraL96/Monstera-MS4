...
class TestOrderModel(TestCase):
    ...
    def setUp(self):
        Order.objects.create(
            ...
            order_total=108.54,
            grand_total=153.86,
            original_cart='test original cart',
    ...
    def test_county_max_length_label(self):
        order = Order.objects.get(id=1)
    ...
    def test_original_cart_label(self):
        order = Order.objects.get(id=1)
        field_label = order._meta.get_field('original_cart').verbose_name
        self.assertEqual(field_label, 'original cart')
